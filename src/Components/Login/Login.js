                ...
                <div style={{ borderRadius: "20px" }} className=" login-container bg-light p-5">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className=" justify-content-center  d-flex mb-1">
                            <button className="main-button w-75"  type="submit" variant="primary" size="md" block>
                    ...
                    <div className="justify-content-center d-flex">
                        <button className="main-button w-75" onClick={handleGoogleSignIn}>sign in with google</button>
                    </div>
                </div>
            </div>
        </div>
